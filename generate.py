...
def Generate_Brain():
   ...
   #pyrosim.Send_Synapse( sourceNeuronName = 0 , targetNeuronName = 3 , weight = 15.0 )
   #pyrosim.Send_Synapse( sourceNeuronName = 1 , targetNeuronName = 3 , weight = 20.0 )
   #pyrosim.Send_Synapse( sourceNeuronName = 0 , targetNeuronName = 4 , weight = 9.0 )
